<x-layouts.employee title="Menu Items">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('employee.menu-items.create') }}"
    ...
    @if(session('flashMessage'))
        <div class="mb-4 p-4 rounded-xl bg-green-900/40 border border-green-600/40 text-green-200">
            {{ session('flashMessage') }}
        </div>
    @endif

    @if(session('error'))
        <div class="mb-4 p-4 rounded-xl bg-red-900/40 border border-red-600/40 text-red-200">
            {{ session('error') }}
        </div>
    @endif
    ...
    <script>
        function openDeleteModal(id, name) {
            ...
            form.action = '{{ url("employee/menu-items") }}/' + id;
