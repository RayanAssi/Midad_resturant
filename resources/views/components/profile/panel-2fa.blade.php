@props([
    'user',
    'mode' => 'link',                    // 'link' للأدمن، 'form' للكاشير
    'enableRoute' => '#',
    'disableRoute' => '#',
    'confirmRouteEnable' => null,
    'confirmRouteDisable' => null,
])
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
                        ...
                        flex flex-col">
                            ...
                            <div class="relative p-6 flex flex-col flex-1 min-h-0">
                                ...
                                <div class="relative">
                                    <div
                                        class="absolute bottom-0 left-0 right-0 h-6 z-10 pointer-events-none
                bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent">
                                    ...
                                    <div class="recovery-scroll overflow-y-auto pl-1 pr-2 space-y-1.5"
                                        ...
                                        @foreach ($user->recoveryCodes() as $index => $code)
                                            <div
                                                class="group/code flex items-center gap-3 px-3 py-2 rounded-lg
                    ...
                    <div class="flex justify-center pt-2">
                        ...
                        @else
                            {{-- 🅱️ للكاشير --}}
                            <form method="POST" action="{{ $disableRoute }}">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                    class="group relative inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold
...
{{-- Styles --}}
<style>
    .recovery-scroll::-webkit-scrollbar { width: 4px; }
