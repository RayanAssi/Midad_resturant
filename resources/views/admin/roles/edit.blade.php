    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-black
            ...
            <div class="px-6 py-5 bg-gradient-to-r from-red-900/60 to-transparent
                ...
                <h2 class="text-2xl font-black text-amber-100">Edit Role: {{ $role->name }}</h2>
                <p class="text-amber-200/60 text-sm mt-1">Update role name and permissions</p>
            </div>
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $role->name) }}"
                           class="w-full px-4 py-3 rounded-xl bg-black/40 border-2 border-red-800/40
                                  text-amber-100 focus:outline-none focus:border-amber-400 transition">
                    @error('name')
