<x-layouts.admin title="Create Menu Item">
    ...
    <div class="max-w-2xl mx-auto">
        <a href="{{ route('admin.menu-items.index') }}"
           class="inline-flex items-center gap-2 text-amber-300/70 hover:text-amber-200 mb-6 transition-colors">
            ← Back to list
        </a>
        ...
        <div class="rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-black
            ...
            <div class="px-6 py-5 bg-gradient-to-r from-red-900/40 to-transparent border-b-2 border-red-800/40">
