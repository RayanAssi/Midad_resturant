<x-layouts.app title="إدارة الطلبات">
    ...
    <div class="space-y-6">
        ...
        <x-card>
            <form method="GET" action="{{ route('orders.index') }}"
                ...
                <x-form.input
                    name="search"
                    label="بحث"
                    placeholder="رقم الطاولة أو العنوان..."
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <x-card variant="success" padding="p-5">
                <p class="text-xs text-amber-200/60 font-bold">إجمالي الإيرادات</p>
                ...
                :rows="$orders->map(function ($order) {
                    return [
                        ...
                        '<span class=\'px-3 py-1 rounded-full text-xs font-bold border
                            ...
                            ' . ($order->type === 'dine_in' ? 'داخل المطعم'
                                : ($order->type === 'delivery' ? 'توصيل' : 'خارجي')) . '
                        </span>',

                        '<span class=\'text-amber-100\'>'
                            . ($order->table_no ? 'طاولة ' . $order->table_no
                                : ($order->address ?? '-')) . '
                        </span>',
                        ...
                        '<span class=\'text-amber-200/60 text-xs\'>'
