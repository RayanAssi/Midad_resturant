<x-layouts.admin title="تعديل فاتورة">
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('admin.invoices.update', $invoice) }}" method="POST"
            ...
            <div>
                <label class="block text-amber-200 mb-2 font-bold">المجموع الفرعي</label>
            ...
            <div>
                <label class="block text-amber-200 mb-2 font-bold">الخصم</label>
            ...
            <div class="bg-blue-500/10 border border-blue-400/30 rounded-lg p-4">
                <p class="text-blue-300 text-sm">
                    💡 الضريبة الحالية: <strong>{{ config('restaurant.tax_rate') }}%</strong>
                    — تُحسب تلقائياً عند الحفظ
                </p>
            </div>

            <div>
                <label class="block text-amber-200 mb-2 font-bold">ملاحظات</label>
